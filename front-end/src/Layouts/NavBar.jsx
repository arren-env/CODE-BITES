    ...
    <nav aria-label="Site Header" className="bg-white dark:bg-black">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              {!authReady ? (
                ...
                <>
                  {user.name}
                  <button
                    className="bg-myOrange px-5 py-2.5 text-sm font-medium text-black shadow transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 hover:bg-orange-400 duration-200 hidden sm:flex"
              ...
              <div className="scale-75 flex items-center text-black dark:text-myOrange -mr-1 md:-mx-1">
      ...
      >
        ...
        <div className="absolute flex justify-center w-[60%] gap-5 items-end top-[87px] py-10 pb-7 mt-5 dark:bg-black bg-white">
          ...
          {user && (
            <button
              className="bg-myOrange px-5 py-2.5 text-sm font-medium text-black shadow transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 hover:bg-orange-400 duration-200 sm:hidden"
              onClick={handleLogout}
            >
              Logout
            </button>
